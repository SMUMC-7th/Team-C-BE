...
import umc.teamc.youthStepUp.domain.profile.recode.response.BookmarkResponseRecord;
import umc.teamc.youthStepUp.domain.profile.recode.response.BookmarkSliceResponseRecord;
